function insect() {
    ...
    function insect_detail(id) {
        $.post("/api/insect_detail", JSON.stringify({ 'id': id }), function (data, status) {
            console.log(data);
    ...
    $.get("/api/all_insect", { 'user': user }, function (data, status) {
        ...
        button.click(function () {
            ...
            $.post("/api/my_insect", JSON.stringify({ "user": user, "data": JSON.stringify(all_insect) }),
