function halobios() {
    ...
    function halobios_detail(id) {
        $.post("/api/halobios_detail", JSON.stringify({ 'id': id }), function (data, status) {
            console.log(data);
    ...
    $.get("/api/all_halobios", { 'user': user }, function (data, status) {
        ...
        button.click(function () {
            ...
            $.post("/api/my_halobios", JSON.stringify({ "user": user, "data": JSON.stringify(all_halobios) }),
